    ...
    <main>
        ...
        <label for="inum"> Digite o numero para ver sua tábua de ZZ </label>
            ...
            <label for="">Digite os numeros para completar a formular: <span class="traço">A</span><span class="traço">x</span>+
                <span class="traço">B</span><span class="traço">y</span>=<span class="traço">C</span></label><br>
        ...
        <section id='resp'>
            ...
            if(!empty($_POST['calcular'])) {
                ...
                echo "<table  >";
                echo '<caption><span class="traço">'.$A.'</span><span class="traço">x</span>+
                <span class="traço">'.$B.'y</span> = <span class="traço">'.$C.'</span></caption><br>';
                    ...
                    for($x= 0 ; $x<$valor;$x++){
                        ...
                        echo "<td >";
                        echo "  SE y = <span class='traço'>". $y."</span> => ";
                        echo "</td>";
            
                        echo "<td >";
                        echo'<span class="traço">'. $A .'</span> .<span class="traço"> '.$x.'</span>+<span class="traço">'.$B.'</span>.<span class="traço">'.$y." </span> = ";
                        echo "</td>";
